package com.practice.cryptocurrency_android.domain.use_case.get_coin

import com.practice.cryptocurrency_android.data.dto.toCoinDetail
...
class GetCoinUseCase @Inject constructor(
    ...
    operator fun invoke(coinId: String): Flow<Resource<CoinDetail>> = flow {
        try {
            ...
            emit(Resource.Loading()) // emit : Flow, Resource.loading : Resource => Flow<Resource<>>
